    ...
    public class Accelerometer : BaseCommand
    {
        ...
        private string GetCurrentAccelerationFormatted()
        {
            try
            {
                ...
                var currentCoordinates = String.Format("\"x\":{0},\"y\":{1},\"z\":{2},\"gx\":{3},\"gy\":{4},\"gz\":{5}",
                                ...
                                (currentReading.OrientationX * gConstant).ToString("0.00000", CultureInfo.InvariantCulture),
                                (currentReading.OrientationY * gConstant).ToString("0.00000", CultureInfo.InvariantCulture),
                                (currentReading.OrientationZ * gConstant).ToString("0.00000", CultureInfo.InvariantCulture));
